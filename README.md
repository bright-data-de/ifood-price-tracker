...
[![iFood Price Tracker](https://img.shields.io/badge/iFood%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/ifood)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/ifood)

Echtzeit-iFood-Preisverfolgung – Brasiliens größte Plattform für Essenslieferungen. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit dem AI Scraper Builder von Bright Data.

---

## Option 1: Bright Insights - KI-gestütztes Price Tracking (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/ifood)** ist die vollständig verwaltete Retail-Intelligence-Plattform von Bright Data. Keine Scraper, die erstellt werden müssen, keine Infrastruktur, die gewartet werden muss – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Verfolgen von Menüpreisänderungen** auf iFood
- ✅ **Monitoring von Liefergebühren und Werbeaktionen** in Echtzeit
- ✅ **Preisvergleich zwischen Restaurants** und Plattformen
- ✅ Überwachung der Einhaltung von MAP-Richtlinien und Erkennung von Preisverstößen
- ✅ Verfolgung von Wettbewerberaktionen und Werbedynamiken
- ✅ Direkte Einspeisung sauberer, harmonisierter Daten in dynamische Preisalgorithmen oder KI-Modelle

> **Ab $250/Monat – [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/ifood)**

---

## Option 2: Erstellen Sie Ihren eigenen iFood Scraper

Keine vorgefertigte iFood-Scraper-API? Kein Problem. Der **AI Scraper Builder** von Bright Data generiert mit nur wenigen Klicks einen benutzerdefinierten iFood-Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren iFood-Scraper in wenigen Minuten

**[Öffnen Sie den iFood AI Scraper Builder →](https://brightdata.de/products/web-scraper/ifood)**
...
- Eine **Web Scraper ID** für iFood (aus dem obigen Build-Schritt)
...
1. **Klonen Sie dieses repository**
   ...
   ```bash
   git clone https://github.com/bright-data-de/ifood-price-tracker.git
   cd ifood-price-tracker
   ```
...
3. **Konfigurieren Sie die Zugangsdaten**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder-Dashboard](https://brightdata.de/products/web-scraper/ifood)
...
Sobald Ihr iFood-Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von iFood-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.ifood.com.br/product/sample-item-123456",
...
Sammeln Sie alle Produkte von einer iFood-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://ifood.com.br/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.ifood.com.br/product/sample-item-123456",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://ifood.com.br/images/product1.jpg"],
...
inputs = [{"url": "https://www.ifood.com.br/product/sample-item-123456"}]
...
- 🌟 [iFood Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/ifood)
- 🏗️ [Build a iFood Scraper](https://brightdata.de/products/web-scraper/ifood)
